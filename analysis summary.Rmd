...
plot(monthdates,100*round(tab1.prop,2)[,2], ylab='Uptake (%)', xlab="Birth Month", main='Uptake by dose and birth month, Oct 2019', bty='l', ylim=c(0, 100), type='l', xaxt='n', xlim=as.Date(c('2016-07-01','2019-10-01')))
...
names(tab1)<-c('Admin. Region', 'Children', 'Children born after Mar 2018')
row.names(tab1)<-NULL
...
for(i in 1:3){
  matplot(surv.summary.c[,i,], type='p', cex=0.25, pch=16,col=cols,bty='l', xlab='Age, months', ylab='Proportion vaccinated',lty=1)
}

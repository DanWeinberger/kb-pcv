...
plot(monthdates,100*round(tab1.prop,2)[,2], ylab='Percent vaccinated', xlab="Birth Month", main='Uptake by dose and birth month as of Feb 2020', bty='l', ylim=c(0, 100), type='l', xaxt='n', xlim=as.Date(c('2016-07-01','2020-03-01')))
points(monthdates,100*round(tab2.prop,2)[,2], type='l', col='blue')
points(monthdates,100*round(tab3.prop,2)[,2], type='l', col='red')
axis(side=1, at=as.Date(c('2016-07-01','2017-07-01','2018-03-01','2018-09-01', '2019-03-01', '2019-09-01', '2020-03-01', '2020-10-01')), labels=c('Jul 2016','Jul 2017','Mar 2018','Sep 2018', 'Mar 2019', 'Sep 2019', 'Mar 2020', 'Sep 2020'))
```
...
First look at  uptake of 1,2, or booster dose by age in all eligible kids born after March 1,2018. This is done as a survival model because of the structure of the data. Many kids in the database don't become age-eligible to receive a dose, so we censor them.
```{r}
